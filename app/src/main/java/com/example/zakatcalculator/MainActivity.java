...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        output3 = (TextView) findViewById(R.id.uruf);
        output4 = (TextView) findViewById(R.id.totalzakat);
        ...
        try {
            switch (v.getId()) {
                ...
                case R.id.btnreset:
                    ...
                    output3.setText("Uruf                      : RM");
                    output4.setText("Total Zakat         : RM");
    ...
    public void calc(){
        ...
        if (stat.equals("Keep")){
            ...
            output3.setText("Uruf                      : RM"+ df.format(uruf));
            output4.setText("Total Zakat         : RM"+ df.format(tZakat));
        }
